class TimerCard {
  ...
  constructor(ch1Title,ch2Title,ch3Title,ch4Title, publishTopic, label, deviceName) 
  {
...
//    if (!disabled) document.getElementById(this.tableId + '-setButton').style.display = "block";
  ...
  setSettings() 
  {
    ...
    socket.emit('publish' + this.deviceName + 'MqttTopic', data2);
  }
  createTimer(tableId) {
